...
_lr_productions = [
  ...
  ('programa -> ALGORITMO ID bloque FIN ALGORITMO','programa',5,'p_programa','Sintax_.py',26),
  ...
  ('instrucciones -> instruccion','instrucciones',1,'p_instrucciones','Sintax_.py',68),
  ('instrucciones -> instrucciones instruccion','instrucciones',2,'p_instrucciones','Sintax_.py',69),
  ('instruccion -> escritura','instruccion',1,'p_instruccion','Sintax_.py',78),
  ('instruccion -> asignacion','instruccion',1,'p_instruccion','Sintax_.py',79),
  ('instruccion -> mientras','instruccion',1,'p_instruccion','Sintax_.py',80),
  ('instruccion -> si','instruccion',1,'p_instruccion','Sintax_.py',81),
  ('asignacion -> ID ASIGNAR expresion PUNTO_Y_COMA','asignacion',4,'p_asignacion','Sintax_.py',86),
  ('asignacion -> ID ASIGNAR expresion','asignacion',3,'p_asignacion','Sintax_.py',87),
  ('escritura -> ESCRIBIR PARENTESIS_IZQUIERDO lista_expr PARENTESIS_DERECHO PUNTO_Y_COMA','escritura',5,'p_escritura','Sintax_.py',96),
  ('escritura -> ESCRIBIR PARENTESIS_IZQUIERDO lista_expr PARENTESIS_DERECHO','escritura',4,'p_escritura','Sintax_.py',97),
  ('lista_expr -> expresion','lista_expr',1,'p_lista_expr','Sintax_.py',102),
  ('lista_expr -> lista_expr COMA expresion','lista_expr',3,'p_lista_expr','Sintax_.py',103),
  ('expresion -> NUMERO','expresion',1,'p_expresion_num','Sintax_.py',113),
  ('expresion -> FLOTANTE','expresion',1,'p_expresion_flota','Sintax_.py',120),
  ('expresion -> CADENA','expresion',1,'p_expresion_cadena','Sintax_.py',127),
  ('expresion -> VERDADERO','expresion',1,'p_expresion_bool','Sintax_.py',135),
  ('expresion -> FALSO','expresion',1,'p_expresion_bool','Sintax_.py',136),
  ('expresion -> ID','expresion',1,'p_expresion_id','Sintax_.py',143),
  ('expresion -> expresion MAS expresion','expresion',3,'p_expresion_binaria','Sintax_.py',152),
  ('expresion -> expresion MENOS expresion','expresion',3,'p_expresion_binaria','Sintax_.py',153),
  ('expresion -> expresion POR expresion','expresion',3,'p_expresion_binaria','Sintax_.py',154),
  ('expresion -> expresion DIVIDIDO expresion','expresion',3,'p_expresion_binaria','Sintax_.py',155),
  ('expresion -> expresion MODULO expresion','expresion',3,'p_expresion_binaria','Sintax_.py',156),
  ('expresion -> expresion IGUAL expresion','expresion',3,'p_expresion_binaria','Sintax_.py',157),
  ('expresion -> expresion DIFERENTE expresion','expresion',3,'p_expresion_binaria','Sintax_.py',158),
  ('expresion -> expresion MENOR expresion','expresion',3,'p_expresion_binaria','Sintax_.py',159),
  ('expresion -> expresion MAYOR expresion','expresion',3,'p_expresion_binaria','Sintax_.py',160),
  ('expresion -> expresion MENOR_IGUAL expresion','expresion',3,'p_expresion_binaria','Sintax_.py',161),
  ('expresion -> expresion MAYOR_IGUAL expresion','expresion',3,'p_expresion_binaria','Sintax_.py',162),
  ('expresion -> expresion Y expresion','expresion',3,'p_expresion_binaria','Sintax_.py',163),
  ('expresion -> expresion O expresion','expresion',3,'p_expresion_binaria','Sintax_.py',164),
  ('expresion -> NEG expresion','expresion',2,'p_expresion_neg','Sintax_.py',175),
  ('expresion -> PARENTESIS_IZQUIERDO expresion PARENTESIS_DERECHO','expresion',3,'p_expresion_paren','Sintax_.py',184),
  ('mientras -> MIENTRAS expresion instrucciones FIN MIENTRAS','mientras',5,'p_mientras','Sintax_.py',190),
  ('si -> SI expresion ENTONCES instrucciones sino_opcional','si',5,'p_si','Sintax_.py',199),
  ('sino_opcional -> SINO si','sino_opcional',2,'p_sino_opcional','Sintax_.py',209),
  ('sino_opcional -> SINO instrucciones','sino_opcional',2,'p_sino_opcional','Sintax_.py',210),
  ('sino_opcional -> empty','sino_opcional',1,'p_sino_opcional','Sintax_.py',211),
  ('empty -> <empty>','empty',0,'p_empty','Sintax_.py',219),
]
